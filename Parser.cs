...
namespace CompiladorPASO
{
    public class Parser
    {
        ...
        {
            // Implementación de expresiones (aritméticas, comparativas, etc.)
            // Aquí implementarás tu lógica para analizar expresiones según la gramática del lenguaje
        ...
        private Token Consumir(TokenType tipoEsperado)
        {
            ...
            throw new Exception($"Se esperaba {tipoEsperado} pero se encontró {ObtenerTokenActual().Tipo}");
        }
